#!/bin/bash
# RNA Inverse Folding — Full Grid Search (3 weight configs × PPO)
# Usage: bash run_grid_search.sh

echo "================================================================="
echo "  RNA Inverse Folding - PPO Grid Search"
echo "================================================================="
...
python train_multi_target.py --algo ppo --seed 42 --weight-config 1

echo -e "\n>>> Step 3/3: Config 2 (Biophysics-focused: 0.4, 0.2, 0.15, 0.25)"
python train_multi_target.py --algo ppo --seed 42 --weight-config 2
